...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
            {new String[]{"a1 9 2 3 1","g1 act car","zo4 4 7","ab1 off key dog","a8 act zoo"}, new String[]{"g1 act car","a8 act zoo","ab1 off key dog","a1 9 2 3 1","zo4 4 7"}}
        });
    }
    ...
    public Tester(String[] logs, String[] expected) {
        this.logs = logs;
    ...
    public void test() {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("method reorderLogFiles() pass unit test!");
        }
    }
