...
public class Tester {
    ...
    public Tester(int n, int[][] edges, int src, int dst, int k, int expected) {
        this.n = n;
        this.edges = edges;
        this.src = src;
        this.dst = dst;
    ...
    @Test
    public void test() {
        int actual = solution.findCheapestPrice(n, edges, src, dst, k);
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("findCheapestPrice() pass unit test!");
        }
    }
